...
'''.format(experiment_name=context['experiment_name'])
    ...
    def _generate_imports(self, context: Dict[str, Any]) -> str:
        ...
        use_optimized = context.get('use_optimized_inference', False)
...
"""
    ...
    def _generate_batch_prediction(self, context: Dict[str, Any]) -> str:
        ...
        use_optimized = context.get('use_optimized_inference', False)
        default_batch_size = 5000 if use_optimized else 1000

        code = f"""# ============================================================================
# BATCH PREDICTION {'(OPTIMIZED)' if use_optimized else ''}
# ============================================================================
