...
class TrainingCodeGenerator:
    ...
    def generate(
        ...
        Args:
            ...
            output_format: Output format ('script', 'function', 'class', 'module')
            include_imports: Whether to include import statements
            modular: If True, generates code suitable for importing as a module
...
"""
    ...
    def _generate_module(self, context: Dict[str, Any], include_imports: bool) -> str:
        """Generate modular training code suitable for importing."""
        hyperparams_str = self._format_hyperparameters(context['hyperparameters'])
        
        code = f"""\"\"\"
Training Module - {context['experiment_name']}
...
if __name__ == '__main__':
    ...
    \"\"\"
    print("=" * 80)
    print("Training Module - {context['experiment_name']}")
    print("=" * 80)
...
def generate_training_code(
    ...
    Example:
        ...
        >>> modular_code = generate_training_code(config, output_format='module')
    """
    generator = TrainingCodeGenerator()
    return generator.generate(training_config, output_format, include_imports, modular)
